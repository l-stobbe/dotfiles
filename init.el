...
(custom-set-variables
 ...
 '(package-selected-packages
   '(general modaled nezburn-theme hc-zenburn-theme zenburn-theme gruvbox-theme catppuccin-theme smart-mode-line-atom-one-dark-theme haskell-mode geiser-guile sly-repl-ansi-color sly guix doom-themes pdf-tools magit poetry vertico use-package orderless marginalia ef-themes corfu))
 '(plisp-documentation-directory "/home/geist/pil21/doc/"))
(custom-set-faces
